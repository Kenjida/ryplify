...
const ProjectList: React.FC<ProjectListProps> = ({ projects, hourlyRate, showInactive, onToggleTimer, onToggleActive, onToggleFree, isReadOnly, liveNotes, handleNoteChange }) => {
